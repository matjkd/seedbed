...
<div style="margin-left:0px;">
    ...
    <div class="four columns alpha feature_box" >
        <div id="bluebox_content">
            ...
            <div class="blue_text">
              <h4> <a href="<?=base_url()?>eatinghouse"> The Eating House</a></h4>
                <p>Hot and cold drinks available on site, all day.</p>
            </div>
        </div>
    ...
    <div class="four columns  omega feature_box">
        <div id="bluebox_content">
            ...
            <div class="blue_text">
                ...
                <p>Conference rooms are available for all tenants</p>
            </div>
        </div>
...
<div class="four columns alpha feature_box" >
    <div id="bluebox_content">
        ...
        <div class="blue_text">
            <h4><a href="<?=base_url()?>map">Secretarial Work</a></h4>
            <p>Fully qualified secretarial staff in house</p>
        </div>
    </div>
...
<div class="four columns omega feature_box">
        <div id="bluebox_content">
            <div class="blue_logo"><img src="<?= base_url() ?>images/icons/white/talk.png"/></div>
            <div class="blue_text">
                <h4>Reviews and Case Studies</h4>
                <p>Coming Soon...</p>
            </div>
        </div>
